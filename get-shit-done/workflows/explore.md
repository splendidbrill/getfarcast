...
@C:/Code/getfarcast/getfarcast/get-shit-done/references/questioning.md
...
```bash
node "C:/Code/getfarcast/getfarcast/get-shit-done/bin/gsd-tools.cjs" commit "docs: capture exploration — {topic_slug}" --files {file_list}
```
