...
```bash
AUDITOR_MODEL=$(node "C:/Code/getfarcast/getfarcast/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read C:/Code/getfarcast/getfarcast/agents/gsd-eval-auditor.md for instructions.
