    ...
    <div className="min-h-screen bg-[#faf8f6] flex items-center justify-center p-6 text-[#1a1a2e]">
      ...
      <div className="relative w-full max-w-md bg-white rounded-3xl p-10 border border-gray-100 shadow-xl z-10 text-center">
        ...
        <button
          ...
          className="w-full h-14 rounded-xl bg-white border border-gray-200 hover:border-blue-200 hover:bg-blue-50 text-gray-800 font-bold text-sm flex items-center justify-center gap-3 transition-all duration-200 hover:-translate-y-1 shadow-sm hover:shadow-xl hover:shadow-blue-500/10"
        >
