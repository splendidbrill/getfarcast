...
Reference full template: `C:/Code/getfarcast/getfarcast/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/Code/getfarcast/getfarcast/get-shit-done/templates/state.md`.
