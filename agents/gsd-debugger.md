...
<required_reading>
@C:/Code/getfarcast/getfarcast/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/Code/getfarcast/getfarcast
                  → checks C:/Code/getfarcast/getfarcast/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/Code/getfarcast/getfarcast/get-shit-done
                  → writes to C:/Code/getfarcast/getfarcast/get-shit-done/hooks/
...
@C:/Code/getfarcast/getfarcast/get-shit-done/references/thinking-models-debug.md
...
- Read @C:/Code/getfarcast/getfarcast/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "C:/Code/getfarcast/getfarcast/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "C:/Code/getfarcast/getfarcast/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "C:/Code/getfarcast/getfarcast/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
