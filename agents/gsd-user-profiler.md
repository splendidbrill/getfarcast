...
<reference>
@C:/Code/getfarcast/getfarcast/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `C:/Code/getfarcast/getfarcast/get-shit-done/references/user-profiling.md` to load:
